class DoctorModel {
  ...
  final String? photo;       // raw path from DB (e.g. "doctors/suresh.png")
  final String? photoUrl;    // full URL provided by backend
  ...
  factory DoctorModel.fromJson(Map<String, dynamic> json) {
    return DoctorModel(
      ...
      photo: json['photo'],
      photoUrl: json['photo_url'],   // full URL generated by Laravel backend
...
class UnitModel {
  ...
  String? get doctorPhoto {
    if (doctors.isEmpty) return null;
    return doctors.first.photoUrl ?? doctors.first.photo;
  }
